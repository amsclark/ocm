...
$a['lsc_problem_menu'] = pikaTempLib::plugin('lsc_problem','problem',$case_row,null);
...
$case_lsc_compliance_template = new pikaTempLib('subtemplates/case-lsc-compliance.html',$a);
$C .= $case_lsc_compliance_template->draw();

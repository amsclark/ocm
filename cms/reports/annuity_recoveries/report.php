...
$report_title = "Annuity Recoveries";
$report_name = "annuity_recoveries";
...
$t->set_table_title('Summary');
$t->set_header(array("Client Matters"));
...
$t->add_table();
$t->set_header(array("Amount Recovered"));
$t->display_row_count(false);
